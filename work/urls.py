...
urlpatterns = [
    ...
    url(r'^get-homework-result/$', get_homework_result, name='get_homework_result'),
    url(r'^get-sign-dtl', get_sign_dtl, name='get_sign_dtl'),
    ...
    # 学生成绩数据展示
    url(r'^my-score/$', student_score, name='student_score'),
    url(r'^get-score-config/$', get_score_config, name='get_score_config'),
    url(r'^get_update_time/$', get_update_time, name='get_update_time'),
    url(r'^save-score-config/$', save_score_config, name='save_score_config'),
]
