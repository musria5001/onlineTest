...
class HomeWork(models.Model):
    ...
    ducheng_problem_ids = models.CharField(max_length=200, verbose_name='读程题id列表', null=True, blank=True)
    ...
    ducheng_problem_info = models.TextField(null=True, blank=True)
...
class HomeworkAnswer(models.Model):
    ...
    student_detail = models.TextField(max_length=300, verbose_name='学生点击数据', null=True)
