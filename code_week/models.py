...
class CodeWeekClass(models.Model):
    ...
    numberEachProblem = models.IntegerField(choices=MAXNUMBER_ONE_PROBLEM, default=2)
...
class CodeDirHistory(models.Model):
    ...
    group = models.ForeignKey(CodeWeekClassGroup, related_name='Code_history', null=True)
